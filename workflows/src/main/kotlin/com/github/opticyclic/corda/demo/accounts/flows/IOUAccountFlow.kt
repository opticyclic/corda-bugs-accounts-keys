...
class IOUAccountFlow(val iouValue: Int, val lenderId: UUID, val borrowerId: UUID) : FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
        ...
        val lenderAccountInfo = accountService.accountInfo(lenderId)
                ?: throw IllegalStateException("Can't find lender account: $lenderId")
        val borrowerAccountInfo = accountService.accountInfo(borrowerId)
                ?: throw IllegalStateException("Can't find borrower account: $borrowerId")
        ...
        //Due to design we must be hosts of the lender account
